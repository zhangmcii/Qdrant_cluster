...
"""
  启动qradnt: docker run -p 6333:6333 -p 6334:6334 -v "$(pwd)/qdrant_storage:/qdrant/storage:z" qdrant/qdrant
...
class Index:
    ...
    def text_split(self):
        ...
        md_header_splits =  md_splitter.split_text(self.md)
        ...
        self.all_splits = text_splitter.split_documents(md_header_splits)

        # self.all_splits = md_splitter.create_documents([self.md])
        # self.all_splits = text_splitter.split_documents(self.all_splits)
